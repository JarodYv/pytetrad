...
class Graph:
    ...
    are endpoints of type Endpoint. We stipulate by extending TetradSerializable
    that all graphs implementing this interface are serializable. This is because
    for Tetrad they must be serializable. (For randomUtil, in order to be able to
    cancel All operations, they must be serializable.)
    """
    ...
    # Returns true iff node1 is a descendent of node2.
    ...
    def is_d_connected_to(self, node1: Node, node2: Node, z: List[Node]) -> bool:
        raise NotImplementedError
